  ...
  const content = [
    {
      ...
      text:
        ...
        `Score strictly within the range 5.0-10.0 — never go below 5.0, no matter how poor the technique looks. This app is meant to feel encouraging even to beginners, so 5.0 represents a rough starting point (not a failing grade), not the bottom of an open-ended scale. ` +
        `Calibrate within that 5-10 range like this: 9.5-10 = world-class/Olympic-level technique, textbook-perfect mechanics with explosive, powerful positions and zero wasted movement; 8.5-9.4 = professional/elite collegiate level, excellent mechanics with at most one very minor refinement; 7-8.4 = strong competitive high school or college level, good fundamentals with a couple of noticeable but not major issues; 6-6.9 = developing athlete, correct basic shape but clear technical gaps affecting efficiency; 5-5.9 = beginner, fundamental technique is largely missing or incorrect. ` +
        ...
        `Important: the "improvements" field existing does not mean you must find something wrong. If you're looking at genuinely elite or Olympic-level footage and nothing significant stands out as a flaw, that is exactly what a 9.0-10 score looks like — say so plainly (e.g. "technique is clean with no significant flaws visible") rather than inventing a minor critique just to have something to put there. Manufacturing criticism to justify a lower score is a mistake — only note something if it would genuinely matter to a coach at that level. Default assumption: if you cannot identify a clear, specific flaw, score 9+. ` +
